...
SELECT PF.COD                         CODIGO_PESSOA_FISICA
    ...
    ,  'Ocorrência cadastrada no sistema' DESCR_TIPO_AFASTAMENTO
 ...
 WHERE OC.COD_SERVIDOR_FK        = SER.COD
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VW_PLANO_ENTREGA" ("COD_PLANO_ENTREGA", "DESCRICAO_ENTREGA", "DESCRICAO_PLANO") AS 
